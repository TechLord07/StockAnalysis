...
> **Add a screenshot here.** After your first run (see [Quickstart](#quickstart)),
> copy `outputs/predictions.png` into a `docs/` folder and embed it with:
> `![Sample prediction](docs/sample_prediction.png)`
> A real result screenshot is one of the highest-value things you can add
> to this README for a CV/portfolio audience.
...
*Fill this in after your own training run — this is what recruiters and
interviewers will actually look at.*
...
A few sentences on what the model does well and where it struggles (e.g.
"tracks the overall trend closely but lags at sharp reversals, which is
expected for a model with no exogenous features like volume or news
sentiment") make this section far more credible than metrics alone.
